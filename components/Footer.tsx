...
export default function Footer() {
  ...
  return (
    <footer className="mt-auto border-t border-[rgba(58,138,24,0.28)] bg-[#070907]">
      <div className="max-w-7xl mx-auto px-5 py-10 grid grid-cols-1 md:grid-cols-3 gap-10 text-center lg:text-left">
        <div>
          <p className="font-display text-3xl tracking-[0.12em] text-white">ASILO</p>
          <p className="mt-4 text-sm leading-7 text-bone/65 max-w-xs mx-auto lg:mx-0">
        ...
        <div>
          ...
          <nav className="flex flex-col items-center lg:items-start gap-3 text-bone/80">
        ...
        <div>
          ...
          <nav className="flex flex-col items-center lg:items-start gap-3 text-bone/80">
            ...
            <Link href="/gate" aria-label="Painel" className="opacity-30 hover:opacity-100 w-fit mx-auto lg:mx-0">
              <Swords size={16} />
            </Link>
          </nav>
        </div>
      ...
      <div className="border-t border-green-border/20 px-5 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 max-w-7xl mx-auto">
        <p className="text-[11px] text-green-muted text-center lg:text-left">
